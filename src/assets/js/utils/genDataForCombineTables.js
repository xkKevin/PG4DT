...
function generateDataForInnerJoin(dataIn1_csv, dataIn2_csv, dataOut1_csv,inExpOrImpCol,naVal){
    let m1 = [[]],m2 = [[]],m3 = [[]]
    let expVal = dataIn1_csv[0][inExpOrImpCol[0]]
...
export {generateDataForInnerJoin,generateDataForFullJoin,generateDataForLeftJoin,generateDataForTablesExtend}
