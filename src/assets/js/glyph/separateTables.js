...
function separate_tables_subset(m1,m2,m3,rule,t1_name,t2_name,t3_name,outColor1,outColor2,name,showTableName){
    if(!showTableName){
        t1_name = ''
        t2_name = ''
        t3_name = ''
...
function separate_tables_decompose(m1,m2s,rule,t1_name,name,showTableName){
    if(!showTableName){
        t1_name = ''
    }
    var svg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
...
function separate_tables_split(m1,m2,m3,rule,t1_name,t2_name,t3_name,outColors1,outColors2,name,showTableName){
    if(!showTableName){
        t1_name = ''
        t2_name = ''
        t3_name = ''
