...
function delete_row(m1,m2,rule,t1_name,t2_name,outColors,name,showTableName) {
    //输入：
    //input和output的矩阵
...
function delete_duplicate_row_partColumn(m1, m2, rule, t1_name, t2_name,inColors,outColors,name,showTableName) {
    if(!showTableName){
        t1_name = ''
        t2_name = ''
    }
