...
function combine_tables_extend(m1,m2,m3,rule,t1_name,t2_name,t3_name,outColors,name,showTableName){
    if(!showTableName){
        t1_name = ''
        t2_name = ''
        t3_name = ''
...
function combine_tables_full_join(m1,m2,m3,rule,t1_name,t2_name,t3_name,naCol,naRow,inColors1,inColors2,outColors,name,showTableName){
    if(!showTableName){
        t1_name = ''
        t2_name = ''
        t3_name = ''
...
function combine_tables_inner_join(m1,m2,m3,rule,t1_name,t2_name,t3_name,inColors2,outColor,name,showTableName){
    if(!showTableName){
        t1_name = ''
        t2_name = ''
        t3_name = ''
